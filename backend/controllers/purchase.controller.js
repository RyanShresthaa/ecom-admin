...
import { nextDocumentNumber } from '../models/sales.model.js';
import { findProductById } from '../models/product.model.js';
import { getDefaultWarehouseId } from '../models/inventory.model.js';
import { addStockInTransaction, removeStockInTransaction } from '../utils/inventoryStock.js';
import { NEPAL_VAT_STANDARD_RATE, purchaseLineAmounts, sumPurchaseLines } from '../utils/nepalVat.js';
import { renderPurchaseBillHtml, renderPurchaseReturnHtml } from '../utils/purchaseDocumentRender.js';
import {
    listSuppliers,
    findSupplierById,
    insertSupplier,
