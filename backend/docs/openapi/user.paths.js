 ...
 *     responses:
 *       200: { description: csrfToken + user in body; JWTs only in httpOnly cookies }
 *
 * /api/user/login-pin:
 *   post:
 *     tags: [Auth]
 ...
 *               pin: { type: string }
 *     responses:
 *       200: { description: Logged in (cookies + csrfToken; no JWTs in body) }
 *
 * /api/user/google:
 *   post:
 *     tags: [Auth]
 ...
 *     responses:
 *       200: { description: New csrfToken; JWTs only in httpOnly cookies }
 *
 * /api/user/csrf:
 *   get:
 *     tags: [Auth]
