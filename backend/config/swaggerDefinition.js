...
| Topic | Detail |
|-------|--------|
| **Auth** | httpOnly cookies \`accessToken\`, \`refreshToken\` (JWTs never in JSON) |
| **CSRF** | Header \`X-CSRF-Token\` when session cookies exist |
| **Checkout** | Required \`Idempotency-Key\` header on place-cod / place-online |
    ...
    components: {
        ...
        parameters: {
            IdempotencyKeyHeader: {
                ...
                description: 'Required for COD and online checkout to prevent duplicate orders',
            },
        },
    },
};
