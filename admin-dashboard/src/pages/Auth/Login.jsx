...
const DEMO_ACCOUNTS = [
  { email: 'admin@matinacrafts.com', password: 'admin123', role: 'admin' },
  { email: 'editor@matinacrafts.com', password: 'editor123', role: 'editor' },
  { email: 'viewer@matinacrafts.com', password: 'viewer123', role: 'viewer' },
]
...
export default function Login() {
  ...
  return (
    <AuthLayout
      ...
      footer={
        <>
          Forgot password? <Link to="/forgot-password" className="font-medium text-primary hover:underline">Reset it</Link>
        </>
      }
    >
