          ...
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-3 pt-0">
              <div className="rounded-lg border border-border bg-secondary/30 p-3">
                ...
                <p className="font-mono text-lg font-semibold tabular-nums">{formatCurrency(customer.lifetimeValue)}</p>
              </div>
              <div className="rounded-lg border border-border bg-secondary/30 p-3">
                <div className="mb-1 flex items-center gap-1.5 text-xs text-muted-foreground">
              ...
              <div className="col-span-2 rounded-lg border border-border bg-secondary/30 p-3">
                ...
                <p className="font-mono text-lg font-semibold tabular-nums">{formatCurrency(customer.avgOrderValue)}</p>
              </div>
            </CardContent>
          </Card>
        </div>
