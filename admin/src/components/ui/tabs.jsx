...
// Tab list wrapper that renders grouped tab triggers.
...
// Individual tab trigger button for switching tab panels.
...
// Tab content panel that renders for the active tab value.
